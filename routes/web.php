...
Route::get('/dashboard', function () {
    ...
    Route::delete('/dossiers-delete/{dossier}', [DossierController::class, 'destroy'])->name('dossiers.destroy');
    ...
    Route::delete('/documents-delete/{document}', [DocumentController::class, 'destroy'])->name('dashboard.documents.destroy');
// });
